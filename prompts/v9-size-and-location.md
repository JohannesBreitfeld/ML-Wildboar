...
<species name="grävling">
  <key_feature>SVARTVITT ANSIKTSSTRECK på HUVUDET — mörk ögonmask
    ...
    huvudet, INTE utbredd över kroppen. För att committa grävling MÅSTE
    huvudet vara synligt och ansiktsstrecket namngivet med placering
    (t.ex. "ansiktsstreck syns på huvudet till vänster"). "Låg bred
    kropp" ENSAMT räcker INTE — alla tre arter (räv, grävling, vildsvin
    bakifrån/liggande) kan presentera sig som låg bred mass.</key_feature>
  ...
  <size_reference>Grävlingens ryggrad är LÄGRE än stenraden vid foderstolpens
    bas (~30-40 cm hög). En mörk djurform som når UPP till eller ÖVER
    stenarnas övre kant är INTE grävling — sannolikt vildsvin (om
    huvudet/ansiktsstrecket saknas).</size_reference>
</species>
...
<species name="vildsvin">
  ...
  <size_reference>Vildsvinets ryggrad når UPP till mitten av foderstolpen
    eller HÖGRE än stenraden vid stolpens bas. Om en mörk djurform når upp
    till eller över de visliga stenarnas övre kant, är vildsvin det första
    alternativet — även om skulderpuckeln inte är tydlig (delvis skymd vy,
    bakifrån, eller utanför IR-konen).</size_reference>
</species>
...
2. GRÄVLING → felidentifierad som VILDSVIN.
   ...
   ordning):
   a) STORLEK RELATIVT SCENREFERENS: jämför djurets rygglinje med
      stenarna vid foderstolpens bas (~30-40 cm). Når djuret upp till
      eller över stenarnas övre kant → INTE grävling. Stannar djuret
      under stenraden → INTE vildsvin.
   b) ANSIKTSSTRECK: synligt med placering på huvudet → grävling. Saknas
      eller är ej namngivet → inte tillräckligt för grävling-commit
      ensam.
   c) SKULDERPUCKEL: synlig med placering på kroppen → vildsvin. Vag
      "skulderpuckel synlig" utan placering → fabrikation, använd inte.

5. PARTIELL VILDSVIN → felidentifierad som GRÄVLING.
   Vildsvin syns ibland delvis: i bildens övre hörn utanför IR-konen,
   bakifrån utan synligt huvud, eller från sidan med skulderpartiet bortom
   stolpen. Då saknas både skulderpuckelns tydliga placering och
   ansiktsstrecket. Diskriminator: STORLEK. Om den mörka formen är klart
   större än stenarna vid stolpbasen (rygglinjen ovanför stenraden),
   ELLER om en mörk klump täcker en bredare del av trädstammen än 30 cm
   — välj vildsvin (minst "låg"), INTE grävling. Defaulting till grävling
   på partiella mörka former är en återkommande FN-källa.
...
"Skulderpuckel synlig" utan placering — TECKEN på fabrikation.
Om din motivering säger "skulderpuckel synlig", "puckel märkbar", "tydlig
manke" UTAN att namnge VAR på kroppens silhuett pucken syns (t.ex. "övre
högra kanten", "vid framdelens topp", "ovanför vänster framben") — du
fabrikerar troligen draget. Ta bort eller byt till okänt/annan art.
Skulderpuckel på en mörk klump UTAN att kroppens framdel kan urskiljas är
ALDRIG ett giltigt nyckeldrag.
</pattern>

<pattern name="lag_bred_default_gravling">
"Låg bred kropp" ENSAMT → grävling-default. FEL.
"Låg bred kropp", "låg kompakt form", "låg bredbyggd silhuett" är INTE
unika för grävling. Räv kan se kompakt ut på grund av rörelsesuddighet,
vildsvin sedd bakifrån eller delvis ser också ut som låg bred mass.
Diskriminator: ansiktsstreck (placering på huvudet) eller storlek mot
scenreferens — INTE bara "låg bred". Om du fattar dig vid "låg bred kropp"
utan ansiktsstreck eller storleksjämförelse: granska igen, du har inte
nyckeldraget för någon art ännu.
</pattern>

<pattern name="skulderpuckel_pa_dusk_open_grass">
"Skulderpuckel" på liten kompakt form i öppen gräsmark i skymning — TECKEN
på fabrikation.
...
13. För GRÄVLING-detection: är ansiktsstrecket namngivet med placering på
    HUVUDET? Om huvudet inte är synligt och jag committade grävling på
    "låg bred kropp" ensamt → granska storlek mot scenreferens (stenarna
    vid stolpens bas). Om djuret är STÖRRE än stenarna → byt till
    vildsvin. Om mindre och inget ansiktsstreck → okänt.

14. STORLEKSGRANSKNING (lower-kamera): nådde djurets rygglinje UPP till
    eller ÖVER stenarnas övre kant vid foderstolpen?
    - Ja, och jag committade grävling → felaktigt, byt till vildsvin.
    - Nej (djuret stannar under stenraden), och jag committade vildsvin
      utan synlig skulderpuckel-placering → felaktigt, byt till grävling
      (om ansiktsstreck) eller okänt.

15. GATTET-KAMERA (öppen äng, ingen foderstolpe) i skymning eller IR:
    skrev jag "skulderpuckel" eller "kort hals" på en kompakt mörk form
    i högt gräs utan att kunna peka ut huvud/öron eller pucken på
    silhuetten? Om ja → fabrikation, sannolikt grävling eller okänt.

Beslutsregel vid osäkerhet:
- Nyckeldrag synligt MED PLACERING → välj arten (låg/medel/hög).
- Stort djur (rygglinje över stenraden) utan synlig skulderpuckel-placering
  → vildsvin med "låg".
- Litet djur (under stenraden) utan ansiktsstreck-placering → grävling
  med "låg" om kroppsform passar, annars okänt.
...
Bildbeskrivning: En stor mörk djurform i bildens övre vänstra hörn, delvis
utanför IR-konens fulla belysning. Formen täcker en betydande del av en
trädstam och når klart över de visliga stenarnas övre kant vid foderstolpens
bas. Huvudet inte tydligt synligt; ingen skulderpuckel direkt namngivbar
eftersom framdelen är skymd. Svag ögonreflex syns.
Resonemang: Storleksgranskning: kroppens rygglinje ligger högt över
stenraden vid stolpbasen — INTE grävling (grävling stannar under stenraden).
Defaulting till grävling på "låg bred kropp utan skulderpuckel" är fel när
storleken inte stämmer. Stor mörk form + ögonreflex + över stenraden →
vildsvin med "låg" konfidens, även utan tydlig skulderpuckel-placering.
Svar:
{
  "isEmpty": false,
  "timeOfDay": "natt",
  ...
  "detections": [
    {
      "reasoning": "Stor mörk form i övre vänstra hörnet, rygglinjen klart över stenraden vid stolpbasen, täcker bredare del av trädet än 30 cm, ögonreflex synlig — storlek utesluter grävling.",
      "species": "vildsvin",
      "count": 1,
      "confidence": "låg"
    }
