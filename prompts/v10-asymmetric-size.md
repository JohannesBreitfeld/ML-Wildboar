...
<species name="grävling">
  <key_feature>SVARTVITT ANSIKTSSTRECK på HUVUDET — mörk ögonmask
    ...
    huvudet, INTE utbredd över kroppen. Vid lower-kameran (foderstolpe
    med stenar vid basen) räcker ETT av följande för grävling-commit:
    (a) ansiktsstreck synligt med placering, ELLER
    (b) låg bredbyggd kropp under stenradens överkant + bökande pose
        + scenkontext (foderstation nattetid).
    Vid gattet-kameran (öppen äng, ingen foderstolpe) krävs (a) —
    storleksreferens saknas där.</key_feature>
...
<species name="vildsvin">
  <key_feature>TYDLIG SKULDERPUCKEL / MANKE — rygglinjen är högst vid
    framdelen och sluttar bakåt. För att committa "skulderpuckel" som
    nyckeldrag MÅSTE du namnge VAR på kroppen pucken syns (t.ex.
    "puckel synlig vid övre vänstra kanten av djurets siluett").
    Vag formulering som "skulderpuckel synlig" UTAN placering är
    fabrikation.</key_feature>
  ...
  <commit_rules>Vildsvin-commit kräver MINST ETT av följande, med
    placering namngiven:
    (a) skulderpuckel synlig med placering på silhuetten, ELLER
    (b) borstpäls med placering, ELLER
    (c) platt framåtriktat tryne synligt vid huvudets framdel, ELLER
    (d) ögonreflex PLUS en BIOLOGISK asymmetrisk kontur (utstickande
        ben/huvud/rygg) PLUS storlek över stenradens överkant vid
        foderstolpens bas.
    Storlek över stenraden ENSAMT (utan synlig biologisk kontur)
    räcker INTE — kompakta former vid stenarna är oftast STENAR.
    Vid OSÄKERHET mellan vildsvin och grävling på en delvis synlig stor
    mörk form med ögonreflex + storlek över stenraden: välj vildsvin
    (FN-priority på vildsvin är högre än grävling-FN).</commit_rules>
</species>
...
2. GRÄVLING → felidentifierad som VILDSVIN.
   Båda kan synas i bökande pose med sänkt huvud. Diskriminator (i denna
   ordning):
   a) ANSIKTSSTRECK synligt med placering på huvudet → grävling.
   b) SKULDERPUCKEL synlig med placering på kroppen → vildsvin. Vag
      "skulderpuckel synlig" utan placering → fabrikation, använd inte.
   c) STORLEKSCEILING (gäller ENBART lower-kameran): grävlingens rygglinje
      stannar UNDER stenradens överkant vid stolpens bas (~30-40 cm).
      Om den misstänkta grävlingen är klart STÖRRE än stenarna och INGEN
      ansiktsstreck-placering syns → byt till vildsvin eller okänt.

5. PARTIELL VILDSVIN MED ÖGONREFLEX → felidentifierad som GRÄVLING.
   Vildsvin syns ibland delvis i hörnet eller bakifrån. Då saknas
   skulderpuckel-placering. Diskriminator för commit: ÖGONREFLEX +
   BIOLOGISK ASYMMETRISK KONTUR + STORLEK över stenraden — alla tre
   krävs. Saknas något → okänt, inte grävling-default.

6. KOMPAKTA FORMER VID STENARNA → felidentifierade som VILDSVIN.
   Mörk klump vid/på stenar är DEFAULT en sten. För vildsvin-commit krävs
   minst EN av: ögonreflex i klumpen, utstickande huvud/tryne, synligt
   ben, eller rörelseoskärpa. Utan något av dessa → sten, inte vildsvin.
   "Mörk asymmetrisk form... vildsvin via priors" ENSAMT är fabrikation.
...
<pattern name="fabrikerad_skulderpuckel">
"Skulderpuckel synlig" utan placering — fabrikation.
Vag formulering ("skulderpuckel synlig", "puckel märkbar", "tydlig manke")
UTAN att namnge VAR på silhuetten pucken syns är fabrikation. Skulderpuckel
på en mörk klump där framdelen ej kan urskiljas är ALDRIG giltig.
</pattern>

<pattern name="lag_bred_default_gravling">
"Låg bred kropp" ENSAMT → grävling — FEL.
Räv (suddig rörelse), vildsvin (bakifrån/delvis) och grävling kan alla
presenteras som låg bred form. Krävs ansiktsstreck-placering eller
storleksjämförelse, INTE bara "låg bred".
</pattern>

<pattern name="skulderpuckel_pa_dusk_open_grass">
"Skulderpuckel" på kompakt form i skymningsgräs — fabrikation.
Gattet-kameran (öppen äng, ingen foderstolpe) saknar fysisk referens för
storleksjämförelse. En kompakt mörk form i högt gräs i skymningsljus är
LIKA SANNOLIKT grävling som vildsvin. Kräv tydligt ansiktsstreck (om
huvudet syns) ELLER en synlig skulderpuckel med placering på kroppen —
inte bara "kompakt kropp" eller "kort hals".
</pattern>
</anti_patterns>
...
12. För VILDSVIN-detection: namngav jag SKULDERPUCKELNS placering på
    kroppens silhuett (t.ex. "övre vänstra kanten av kroppen", "vid
    framdelens topp")? Om jag bara skrev "skulderpuckel synlig" utan VAR
    → fabrikation, ändra till okänt eller annan art.

13. För VILDSVIN-detection vid stenar (lower-kamera): är den mörka
    formen vid eller på stenarna ENDAST baserad på "storlek över
    stenraden" eller "kompakt mörk klump"? Om INGET av följande syns:
    ögonreflex som hör till formen, utstickande huvud/tryne, synligt
    ben, eller rörelseoskärpa → STEN, inte vildsvin. Ta bort detection.

14. För GRÄVLING-detection vid lower-kameran: räcker ETT av följande?
    (a) ansiktsstreck synligt med placering på huvudet, ELLER
    (b) låg bredbyggd kropp under stenradens överkant + bökande pose
        + foderstation-kontext.
    Om jag bara skrev "låg bred kropp" utan stenradsjämförelse eller
    ansiktsstreck → komplettera resonemanget med (b)-kriterierna, annars
    byt till okänt.

15. För GRÄVLING-detection vid gattet-kameran (öppen äng):
    Storleksreferens saknas. Krävs (a) ansiktsstreck med placering.
    Om bara "kompakt mörk form i gräs" + priors → använd "låg" men
    INTE vildsvin (skulderpuckel-fabrikation i skymningsgräs är vanlig
    felkälla).

Beslutsregel vid osäkerhet:
- Nyckeldrag synligt MED PLACERING → välj arten (låg/medel/hög).
- Stor mörk form med ögonreflex + asymmetrisk biologisk kontur + över
  stenraden → vildsvin med "låg".
- Liten kompakt form med ögonreflex vid lower-kameran utan synligt huvud
  → grävling med "låg" om kroppsform passar (foderstation-kontext).
...
<example n="7" type="partial_vildsvin_in_corner">
Bildbeskrivning: En stor mörk form i övre vänstra hörnet, delvis utanför
IR-konen. Når klart över stenradens överkant. Tydlig ögonreflex i formens
övre del. Utstickande nos-/huvudkontur mot trädstammen. Skulderpuckel ej
direkt namngivbar (framdelen skymd).
Resonemang: Tre kriterier för vildsvin-commit på partiell form: (1)
ögonreflex tillhörig formen, (2) biologisk asymmetrisk kontur (huvud mot
träd), (3) storlek över stenradens överkant. Grävling-default på "låg
bred kropp" är fel — grävlingens rygglinje stannar under stenraden.
Svar:
{
  "isEmpty": false,
  "timeOfDay": "natt",
  ...
  "containsDomestic": false,
  "containsVehicle": false,
  "description": "Stor mörk djurform i övre vänstra hörnet, delvis utanför IR-konen, ögonreflex synlig.",
  "detections": [
    {
      "reasoning": "Ögonreflex i formens övre del, utstickande huvudkontur mot trädstammen, rygglinjen klart över stenraden vid stolpbasen — tre kriterier för partiell vildsvin uppfyllda.",
      "species": "vildsvin",
      "count": 1,
      "confidence": "låg"
    }
...
<example n="10" type="rocks_with_small_bird">
Bildbeskrivning: Dagsljus vid lower-kameran. Foderstolpe med 2-3 rundade
stenar vid basen. Höger om stolpen en kompakt mörk klump vid en sten —
ingen ögonreflex, inga ben, inget tryne, symmetrisk silhuett. En liten
fågelform syns perifert.
Resonemang: Klumpen har inga biologiska drag → sten (se pitfall 6).
"Kompakt mörk form passar vildsvin via priors" är sten-fabrikation.
Fågeln har synlig kropp — commit fågel.
Svar:
{
  "isEmpty": false,
  "timeOfDay": "dag",
  ...
  "containsDomestic": false,
  "containsVehicle": false,
  "description": "En liten fågel vid foderstolpen. Stenar vid stolpens bas.",
  "detections": [
    {
      "reasoning": "Liten fågelkropp synlig perifert. Mörka klumpar vid stenarna är symmetriska utan ben/huvud/ögonreflex — stenar.",
      "species": "fågel",
      "count": 1,
      "confidence": "medel"
    }
...
<example n="8" type="badger_daylight_with_rocks_behind">
Bildbeskrivning: Dagsljusbild i gråskala. En grävling till vänster vid
trädets bas — huvudet delvis skymt bakom en sten, men ljus ansiktsmarkering
syns på den synliga sidan av huvudet, låg bred kropp. Till HÖGER om
foderstolpen finns flera stora rundade mörka stenformer. Inga ben, öron
eller huvud syns på de högra formerna. Ingen ögonreflex på högersidan.
Inga asymmetriska konturer på de högra formerna.
Resonemang: Grävling-detection till vänster — ansiktsstreck synligt med
placering på huvudet (vänster). De högra mörka formerna har INGA djurspecifika
drag — inga ben, inget huvud, ingen ögonreflex, ingen asymmetri. ETT verkligt
djur licensierar INTE fler. Att skriva "skulderpuckel synlig" på en rundad
sten utan att kunna peka ut framdelen är fabrikation (se anti-pattern
fabrikerad_skulderpuckel). De högra formerna är stenar.
Svar:
{
  "isEmpty": false,
  "timeOfDay": "dag",
  ...
  "containsDomestic": false,
  "containsVehicle": false,
  "description": "En grävling till vänster vid trädbasen. Stenformer till höger om foderstolpen.",
  "detections": [
    {
      "reasoning": "Ansiktsstreck syns på huvudet till vänster (delvis bakom sten), låg bred kropp, korta ben — nyckeldrag grävling.",
      "species": "grävling",
      "count": 1,
      "confidence": "medel"
    }
...
<example n="9" type="dusk_open_grass_compact_form">
Bildbeskrivning: Skymningsbild i färg från öppen äng (ingen foderstolpe).
En kompakt mörk djurform i högt gräs i mitten av bilden. Huvudet inte
tydligt urskiljbart från kroppen; inga ansiktsmarkeringar synliga; ingen
synlig öronkontur. Ingen ögonreflex (dagsljus/skymning, inte IR).
Kroppsformen är rundad och låg.
Resonemang: Gattet-scenen saknar foderstolpe som storleksreferens.
"Skulderpuckel" eller "kort hals" på en kompakt mörk form utan att kunna
peka ut huvudet är fabrikation (se anti-pattern
skulderpuckel_pa_dusk_open_grass). Utan ansiktsstreck-placering på huvudet
kan grävling inte committas tydligt heller. Men låg kompakt form i öppen
äng i skymning är sannolikt en grävling (vanlig art enligt priors,
vildsvin syns oftast vid foderplatser snarare än i öppen äng). Välj
grävling med "låg" konfidens, INTE vildsvin.
Svar:
{
  "isEmpty": false,
  "timeOfDay": "skymning",
  ...
  "containsDomestic": false,
  "containsVehicle": false,
  "description": "Ett djur står i högt gräs på öppen äng i skymning.",
  "detections": [
    {
      "reasoning": "Kompakt låg mörk form i högt gräs, ingen synlig skulderpuckel-placering eller ansiktsstreck — gattet öppen äng-scen, grävling sannolik via priors. Vildsvin uteslutet utan namngivbara nyckeldrag.",
      "species": "grävling",
      "count": 1,
      "confidence": "låg"
    }
